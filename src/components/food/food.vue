  ...
  <div class="food" v-show="showFlag" ref='food'>
    <div class="food-content">
      ...
      <div class="rating">
        ...
        <ratingselect v-on:ratingtypeSelect="ratingtypeSelect" @toggle="contentToggle"    :selectType="selectType" :onlyContent="onlyContent" :desc="desc" :ratings="food.ratings"></ratingselect>
